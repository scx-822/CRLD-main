...
def main(cfg, resume, opts):
    ...
    train_loader, val_loader, num_data, num_classes = get_dataset_strong(cfg)  # get_dataset_strong only; no get_dataset
        ...
        if cfg.DATASET.TYPE == "imagenet":
            ...
            if cfg.DISTILLER.TEACHER == 'vit':
                ...
                vit_model_prefix = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                                "..//download_ckpts/tinyimagenet_teachers/vit_large_384/")
                ...
                assert (pretrain_model_path is not None), "no pretrain model for teacher {}".format(
