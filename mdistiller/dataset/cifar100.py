...
class MultipleApply: # see github.com/thuml/Transfer-Learning-Library
...
def get_cifar100_train_transform_strong():
    train_transform_weak = transforms.Compose( # weak augmentation = Crop + Horizontal Flip
        [
            transforms.RandomCrop(32, padding=4),
            transforms.RandomHorizontalFlip(),
            transforms.ToTensor(),
    ...
    train_transform_strong = transforms.Compose( # strong augmentation = Crop + Horizontal Flip + RandAug
        [
            transforms.RandomCrop(32, padding=4),
            transforms.RandomHorizontalFlip(),
            RandAugment(2, 10),
